...
;(function ($, window, document) {
    ...
    Indicator.prototype = {
        ...
        value: function (val) {
            ...
            var perVal = ((val - minVal) * 100 / (maxVal - minVal)).toFixed(2), //percentage value tp two decimal precision
            ...
            if (indOption.displayNumber) {
                ...
                // ctx.fillText(voteNum, center, center+10);
            }
